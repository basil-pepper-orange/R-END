...
const CHARACTERS_ALL = [
  ...
  { id: 'gold', elem: 'flame', name: 'ゴルド', title: '砂の鉄巨人', rarity: 3,
    desc: '砂に埋もれていた守護機。命令は消えたが、消えたという記録だけが残っている。',
  ...
  { id: 'reia', elem: 'sea', name: 'レイア', title: '流れ者の早撃ち', rarity: 2,
    ...
    lost: { name: '近接連弾', type: 'oath', power: 10.0, up: 1.00, turns: 3,
            ...
            lines: ['逃げ足は、過去に置いてきた', 'あたしが前に出て、逃げ場所を守る'] },
  },
...
const ENEMIES_ALL = [
...

  {
    ...
    skills: [
      { name: '戴冠の重み', kind: 'aoe', power: 1.15, every: 4,
        ...
        lines: ['重かろう。余は三十年これを載せている', 'お前たちとは、重みが違う'] },
...

  {
    ...
    skills: [
      ...
      { name: '名を薄める', kind: 'single', power: 1.70, every: 4, seal: { turns: 1 },
...
const PROLOGUE = {
  chapter: '序景', place: '灰の降りはじめ',
  blurb: 'この世界に何が起きたのか。旅がはじまる前の話。',
  image: 'title.jpg',
  lead: [
    '',
    'はじまりは、30年あまりも前のこと。',
    '広い世界、その各地で人の「記憶」に異変が起きはじめた。',
    '皆、ものごとを覚えていられる時間が急速に短くなっていった。',
    '',
    '人は、思い思いの方法で抗った。',
    '記憶を書き留める。繰り返し読む。互いに確かめ合う。',
    'しかし「記録」が増えれば増えるほど、信じてよいものを見失った。',
    'これは誰が書いたのか。本当にそうなのか？',
    '記録したことを覚えている時間すらも、徐々に失われていった。',
    '記録に溢れかえった世界は、やがて混乱し、静かに衰えていった。',
    '',
    '記憶が失われていくこの現象を、人は「記憶が灰になる」と呼んだ。',
    '',
    '時を同じくして、世界そのものの「崩壊」が始まった。',
    '人の手が作り上げたもの——建物も、機械も、書物も、記録も、',
    '以前の何倍もの速さで風化していくようになった。',
    'まるで、最初から無かったかのように。',
    '文字通りの目に見える「灰」となって、風に流された。',
    '',
    '人が忘れていくのと同じ速さで、世界のほうも白紙に戻っていった。',
    '',
    'この現象が始まる前の世界を知る者の、苦しみ。',
    'この現象が始まったあとの世界しか知らぬ者の、哀しみ。',
    '',
    '失われていくこの世界では、名もなき風景ばかりが増えていく…。',
    '',
  ],
  ask: '——十二枚の風景に導かれた十二の想いが、いまここに集まり、この世界の記憶を繋ぎとめるために歩み出す。',
};

const CHAR_STORY = {
  shion: {
    chapter: '第零景', place: 'あたしが見て伝えるから',
    lead: [
      '世界が崩壊をはじめた何年もあとに、シオンは生まれた。',
      '育ててくれたその人は、崩壊の前の世界の事をときどき語った。',
      '丘の向こうに湖がある、あの川には橋がある、と懐かしむように言った。',
      '幼い頃、シオンはそれを聞くと、嬉しくなり走って確認しに行った。',
      '「湖はあった。橋はざんねん、落ちていた」',
      '帰ってそう伝えると、その人は優しい笑顔で聞いて次の行き先を教えてくれた。',
      '',
      'そんな日々が、何年も続いた。',
      'ある日、その人は、以前訪れて感動したという大きな塔の話をしてくれた。',
      'シオンはいつものように準備を整え、走って見に行った。',
      'そして、帰ってくるなり、塔がまだ残っていたことを嬉しそうに話すと、',
      'その人は、とても困ったような表情で言った。',
      '「——そんな塔があるんだね、いつか見に行きたいね」',
      '',
      'シオンはその日から、より速く走るようになった。',
      '帰り着くまでに忘れられてしまうなら、もっと速く帰って速く伝えるしかない。',
      '',
      'ある日のこと。',
      '灰をかき分けてやってきた訪問者は、荷物から絵を出した。',
      'これがどこの景色か知らないか、と聞いてくる。',
      '記憶にはなかった。シオン自身も、失われていく記憶と戦っていた。',
      'シオンは、顔を上げた。',
      '「少し待っててくれる？見てくればいいでしょ？」',
    ],
    ask: '——大丈夫。記憶になくても、あたしがまた見てきて伝えるから。',
  },

  hazuki: {
    chapter: '第零景', place: '灰の下の花',
    lead: [
      'ハズキは、崩壊のあとに生まれた。',
      '刀は、老いた人に習った。「身体で覚えた技は、忘れない」とよく話す人だった。',
      'その人は稽古のたびに知らない花の名前を口にした。',
      'いつか見てみたいと思ったが、そのことすら気付くことなく忘れていく。',
      'いつしか、無理に名前を覚えようとすることは諦めた。',
      '「抜いたら、納めろ」と、その人は言った。',
      '「お前は、納める場所を忘れた刀になるな」と、そう言った。',
      '',
      'その人が世界からいなくなった日、ハズキは刀を抜いた。',
      '相手が倒れても、腕が止まらなかった。納める場所が、どこにも無かった。',
      '灰の上に座り込んで、手をついた。涙で、視界がにじむ。',
      '指先に、何かが触れた。灰をどけると、白い花が一輪だけ咲いていた。',
      'そっと摘んで、名もなき花を髪に挿すと、心が少し落ち着いた。',
      '「お前は、納める場所を忘れた刀になるな」という声が聞こえた気がした。',
      'ようやくのこと、刀を鞘に戻すことができた。',
      '',
      '灰をかき分けて誰かが来た。',
      '荷物から絵を出して、これはどこの景色か知らないかと聞いた。',
      'ハズキは首を振ってから、聞き返した。',
      '「その景色には、名前があるのですか」',
    ],
    ask: '——では、私が行きましょう。名前のある花を、一度見てみたいので。',
  },

  baldo: {
    chapter: '第零景', place: '灰になった酒場',
    lead: [
      '崩壊から30年。',
      '街はとうに灰で、酒場だったところには壁が少し残っているだけだ。',
      'バルドは毎晩そこに座って、ひとりで酒を飲んでいた。',
      '杯は少し欠けていた。義手で持つと、いつも同じところが唇に当たる。',
      '杯を口に運ぶたびに、かつての仲間の名前をつぶやいた。',
      '覚えている数だけ繰り返すと、朝になっていることもあった。',
      '',
      '「飲んで忘れた口だ」と、彼は誰にでもそう言った。',
      'しかし実際には、ひとりも忘れていなかった。',
      '',
      'その日、灰をかき分けて若い連中が来た。',
      '荷物から一枚の絵を出して、これはどこの景色か知らないかと聞いた。',
      'バルドは長いこと見ていた。',
      '門の手前に朝市が立っていた場所だった。',
      '魚を売っていた男の名前も、まだぼんやりと出てきた。',
      '「知ってるよ」',
      'そう言ってから、杯を持ち上げて残りを飲み干した。',
      '「あんたら、それを持って歩くのか」',
      '若い連中はうなずいた。バルドは立ち上がって、自らの酒を背中に抱え直した。',
      '酒はまだ重かったが、覚えている名前の方がずっと重かった。',
    ],
    ask: '——なら、俺も行こう。荷物持ちくらいにはなるだろ。',
  },

  raizu: {
    chapter: '第零景', place: '傾いた船の賭場',
    lead: [
      'ライズは、崩壊のとき10歳に満たない年齢だった。',
      '船の賭場で育った。',
      '母は札を配る人で、ライズは卓の下で大人の靴ばかり見ていた。',
      '靴の向きや足の動きで、誰が降りるかは先に分かった。',
      '',
      '灰の降りはじめた夜、船は傾いていた。それでも卓は立っていた。',
      'ひとり、またひとりと靴が離れ、降りると言って出ていった人は、',
      '朝には何を降りたのかを忘れていた。',
      '母は座ったままだった。',
      '「降りたら、何を賭けてたかまで忘れちまうよ」と言った。',
      '意味は分からなかったが、母の靴だけは、ずっと卓を向いていた。',
      '',
      'ある朝、母はライズの名を呼ばなかった。',
      '指輪を抜いて卓に置き、知らない人の顔で笑って、そのまま去った。',
      'ライズはその指輪を拾った。',
      'まだ私は卓を降りていないのだから、総取りだ。そう決めた。',
      '',
      '指輪はそれから30年で増えた。',
      '世界をあちらこちら移動しては、張った。',
      '数は数えない、数えたら張れなくなるから。',
      '',
      'ある時、相手が卓に一枚の風景画を置いて言った。',
      '「灰を、終わらせる」',
      'ライズは声をあげて笑った。',
      '勝ち目の薄い話だと思ったが、ライズは指輪を全部外し、卓に並べた。',
    ],
    ask: '——乗るわよ。あたし、まだ一度も降りていないの。',
  },

  rita: {
    chapter: '第零景', place: '帳面だけ残った家',
    lead: [
      'リタは、崩壊のあとに生まれた。',
      '一緒にいた人は、とにかく何でも書き残す人だった。',
      '誰と会って、何を約束したのか、毎日書き足していた。',
      '「文字は、そのうち教えてやる」と言われたが、そのうちは来なかった。',
      'リタは、書き残す術を知らないまま育った。',
      '',
      'その人がいなくなって、積みあがった帳面だけが残った。',
      'リタは開いて、随分と長いこと見ていた。',
      'それでもそこに何が書いてあるのか、一行も分からなかった。',
      '',
      '手に触れた棒で、帳面の積みあがった棚を殴った。',
      'こんなものが何になるんだ、と思った。',
      '棚は壊れ、中にあったその人の杯まで割れてしまった。',
      '壊すつもりのなかったものまで、壊れた。',
      '',
      '棒を捨てて、今度は手で殴った。手の皮が裂けた。',
      'それから3日たっても手は痛くて、そのたびにあの日のことを思い出した。',
      '帳面より、こっちのほうがよっぽど読めた。',
      'それきり、武器は持っていない。棒は、当たる先を選ばない。',
      '拳なら、殴ったところしか壊れない。そして、忘れない。',
      '',
      '灰をかき分けて誰かが来て、絵を見せた。ずいぶん長い話だった。',
      'リタは半分も聞かないうちに、拳を鳴らして立ち上がった。',
    ],
    ask: '——で、どれを壊せばいいの？　……あ、壊しちゃダメなやつは、先に言っといてよ。',
  },

  muse: {
    chapter: '第零景', place: '気休めの薬',
    lead: [
      'ミュゼは、崩壊のはじまる頃に生まれた。',
      '幼過ぎたため、崩壊前を知る世代、ということにはならない。',
      '',
      'ミュゼに薬を教えた人は、記憶の消失を病気だと思っていた。',
      'そうして何年もかけて、記憶を留めやすくする薬を開発した。',
      '気休め程度の効果ではあったが、確かに効果はあった。',
      '',
      'その処方を、ミュゼは毎日隣で一緒に作ることで覚えた。',
      '書いた記録よりも、手先の方が正確に覚えた。',
      '薬の師とも呼べるその人は、頑なに自分の薬を後回しにし、',
      '作った端から、訪れた人に渡していた。',
      '',
      'ある時、師がミュゼの顔を見て、名を思い出すのに少し時間がかかった。',
      'ミュゼはその日から、自分も薬を飲みはじめた。',
      '自分が処方を忘れてしまったら、この薬が世界から消える。',
      '気休めでも、誰かの助けになるはずだと、信じた。',
      '',
      'ある日、灰をかき分けて診察に来た何人かが、絵を見せて語った。',
      'それは風景画で、綺麗だと思った。',
      'ミュゼはその人たちの手と、目を見る。',
      'その旅には、自分の診察と薬が必要に思えた。',
    ],
    ask: '——ええ、行きましょう。……その前に全員、座って。順番に診るから。',
  },

  kain: {
    chapter: '第零景', place: '数の合わない家',
    lead: [
      'カインは崩壊のあとに生まれた。',
      'いちばん早く覚えたのは、数を数えることだった。',
      '一緒に暮らしていた人たちは、よく物を無くした。',
      'それで困ることはなかった。',
      '無くしたことも一緒に忘れるから、誰も探さない。',
      '',
      'カインだけが探した。朝に17あったものが、夜には16になっている。',
      'それが分かるのは、朝に数えていたからだ。',
      '「気にするな」と言われた。',
      '「そんなもの、はじめから無かったんだろう」',
      'カインはその一言を、いちばん怖いと思った。',
      '',
      '弓を覚えたのは、矢を拾うことが、数を数えることが気に入ったからだ。',
      '射れば矢は遠くへ行く。歩いて行って、数えながら取り戻す。',
      '数で忘れていないことを確認する。',
      '拾って束ね直して、数が合えば、その日は何も失っていない。',
      '',
      'ある日、灰をかき分けて来た人が、絵を見せた。',
      'カインはその風景を長いこと見てから、矢筒の中を数えた。17本あった。',
    ],
    ask: '——行きます。その景色も、まだ拾いに行けるということでしょう。',
  },

  reia: {
    chapter: '第零景', place: '名前を呼ばれない町',
    lead: [
      'レイアは崩壊のあとに生まれた。',
      'そして、ひとつの町で、十年以上暮らした。',
      'あの頃は、逃げ足なんて言葉も知らなかった。',
      '',
      '町の人は、みんなレイアを知っていて、名前も呼ばれた。',
      'だから、呼ばれる回数が少しずつ減っていることには、しばらく気づかなかった。',
      'ある朝、町中で挨拶をしたら、相手が困った顔をした。',
      '悪気はない。名前が出てこないだけだ。',
      '次の日は別の人が、その次の日はもっと近くの人が、同じ顔をした。',
      '',
      'レイアは育った町を出た。',
      '次の町では、着いたその日に名前を聞かれた。',
      'レイアは名前を伝え、そうして、忘れられる前には町を出た。',
      '',
      'そうして色々なものから逃げるように、各町を旅した。',
      '',
      '帽子を深くかぶるのは、相手の目を見なくて済むからだ。',
      '覚えているかどうかは、目に出る。',
      'あんな目は、もう見たくない。',
      '',
      'ある町で、灰をかき分けて来た人たちが、1枚の風景画を見せた。',
      'レイアは帽子のつばを上げて、その人たちの顔を、めずらしく正面から見た。',
    ],
    ask: '——あたし、すぐ逃げると思うけど。……行けるところまで、行くよ。',
  },

  alvis: {
    chapter: '第零景', place: '残った命令',
    lead: [
      'アルヴィスに命じた声は、崩壊がはじまった後、すぐに絶えた。',
      '残った命令は、ひとつだけ。',
      '——「守れ」。',
      'その対象が誰だったのか、記録には残っていない。',
      '書かれていたのかもしれないが、その部分は残っていない。',
      '',
      '機械であるアルヴィスに、「記憶」という概念はない。',
      '記憶の灰は一片も積もらなかったが、機械は壊れる。崩壊には勝てない。',
      '残った命令もやがては崩れて消えていくであろう。',
      'アルヴィスは、最後に残った命令に従った。',
      '各地で、何かを守った。',
      '本当に守るべきものが何であったのか、',
      'それがまだ残っているのか、それはもう分からない。',
      '',
      '随分と長い時が過ぎた頃、灰をかき分けて来た人に、絵を見せられた。',
      'こんな壊れた機械に、話しかける人はめずらしかった。',
      'アルヴィスは絵の中の景色を、長いこと見ていた。',
    ],
    ask: '——その景色はまだ在るのか。……ならば、守るものが決まった。',
  },

  gold: {
    chapter: '第零景', place: '命令の消えた砂原',
    lead: [
      'ゴルドは崩壊がはじまった年に砂に呑まれた。',
      '大きな戦の最中だったその頃から、30年その下で停止していた。',
      '',
      'その後の世界がどうなったのかを、知らない。',
      '積もった灰が風の向きを変え、30年かけて砂が退き、ゴルドは目覚めた。',
      '関節は動いた。立つ動作は、忘れていなかった。',
      '30年ぶん砂に身を削られ、記録もほとんど残っていない。命令主、消失。',
      '命令内容、消失。「消失した」というエラーだけが残った。',
      '',
      'それは、人には起こらないことだ。人は無くしたことごと忘れる。',
      'ゴルドは、無くしたことだけを持っていた。',
      'だから待った。命令はいずれ来るはずだった。',
      '来るまでは、動かない理由になる。',
      '',
      'ある頃、灰をかき分けて見知らぬ姿が近づいた。',
      'ひとりが胸の板の錆を払い、1枚の風景を見せた。',
      '「いいだろう、新しい命令か、そこを読んで伝えろ」',
      '胸の板の錆の下の文字を読ませ、自らに命令を伝えさせた。',
      'ひとりが言った。「お前が必要だ、行こう」',
    ],
    ask: '——受領した。命令には聞こえなかったが、この場に留まる理由はもうない。',
  },

  owen: {
    chapter: '第零景', place: '白くなっていく書架',
    lead: [
      'オーウェンは崩壊の前から司書だった。蔵書は数えたことがない。',
      '数えられる量ではなかった。',
      '崩壊がはじまった直後は、書架に人が並ぶこともあった。',
      'しかし時が経つにつれ、貴重な記憶の領域を書物に使う人が減った。',
      '',
      'ある時、誰も読まない本から順に、頁が白くなっていくことに気付いた。',
      '書いてあっても、読まれなければ消える。',
      '同じ仕事の者は他にもいたが、ひとり、またひとりと読むのをやめていった。',
      'オーウェンは朝から晩まで読んだ。',
      'だが、ひとりで回れる棚の数は決まっている。回れなかった棚はやがて白くなる。',
      '毎朝どの棚から読むかを決めた。——つまり、どれを諦めるかを決めた。',
      '白くなってしまった本は、題名だけを別の帳面に書き写した。',
      '守れなかったものの名を書く頁で、それは日に日に厚くなった。',
      '',
      '最後に手元に残せるのは、数えられる量だけになるだろうと感じた。',
      'そうして、守れなかった書物よりも、目にした大事な事を記して残すことに決めた。',
      '',      
      'ある時書架に、とある一行が現れ、1枚の風景画を見せて語った。',
      'オーウェンは久しぶりに本を閉じた。',
      '諦めかけたが、もう少し本を残すことができるのかもしれない。',
      '持ち運べるだけの本を抱え、出かける準備をはじめる。',
    ],
    ask: '——同行しよう。全てが白紙になる前に帰ってこよう。',
  },

  erna: {
    chapter: '第零景', place: '誰も払わなかった灰',
    lead: [
      'エルナは年齢を明かさない。',
      'ただ、崩壊がはじまった時には、もう大人の容姿をしていた。',
      '',
      '灰が降りはじめた日のことを覚えている、数少ないひとりだ。',
      '最初は誰もが灰を払った。汚れだと思ったからだ。',
      'エルナは払わずに、灰を指でつまんで、しばらく見ていた。',
      '',
      '灰には、消えたものの形が残っていた。',
      '読めると気づいたのは、たぶん世界でエルナが最初だった。',
      'ただそんなことができるのは、彼女の他にはいなかった。',
      '',
      '目に見えて降る崩壊の灰、目に見えぬ人が失った記憶の灰。',
      'どちらであっても、よく目を凝らせば、ある程度は辿れる。',
      '',
      '崩壊による灰は、よく燃えた。',
      '彼女は、灰を読んだ後、世界に対する一種の弔いのように燃やした。',
      '',
      'ある時、灰をかき分けてやってきた人たちが、風景画を見せて、彼女に語りかけた。',
      'エルナはレンズを下ろし、その人たちの足元の灰を読んだ。',
      'それだけで、彼女には十分伝わった。',
    ],
    ask: '——いいわ、行きましょう。きっと私が必要になるから。',
  },
};
...
const CHAR_TALE = {
  baldo: {
    ...
    e6: { act: '玉座の前で立ち止まり、酒の栓を抜かずに握っていた。', line: 'あんた、三十年も一人で覚えててくれたのか。……悪いな。俺は、飲んで忘れた口だ' },
  ...
  rita: {
    ...
    e7: { act: '白紙を一枚つかんで、握りつぶしてから放した。', line: '真っ白じゃん。……あたし、字は読めないけどさ。無いのは分かる' },
  ...
  gold: {
    ...
    e4: { act: '白冠の姿を認識し、動作が一拍だけ遅れた。', line: '……照合、不能。記録は、残っていない。……それでも、優先度は高い' },
  ...
  muse: {
    ...
    e6: { act: '王の指先が震えているのを見て、瓶を握りしめた。', line: 'ずっと起きているでしょう。……三十年も。それは、もう病気よ' },
  ...
  raizu: {
    ...
    e4: { act: '白い地平に指をかざして、色の残りを探した。', line: 'イカサマは嫌いよ。……盤ごと白く塗るなんて、いちばん質が悪い' },
...
const PAIR_TALE = {
  ...
  'alvis|owen':   ['守れなかった名を、覚えているか', '全員ぶんだ。……あなたの記録が崩れても、こちらに残る'],
  ...
  'gold|erna':    ['解析を、要請する', 'あなた、砂の下で三十年。……ずいぶん待たされたわね'],
  ...
  'owen|muse':    ['あなたの処方を、記録してもいいか', 'いいけど。……分量は、紙より手のほうが覚えているの'],
  ...
  'reia|kain':    ['あんたと撃ち合ったら、どっちが速い', 'あなたです。僕は、外さないだけなので'],
  'erna|raizu':   ['その指輪、ずいぶん灰をかぶってるわね', '拾った場所を聞かないでくれる？ ……勝って取ったのは本当よ'],
  'erna|kain':    ['矢に火を移してあげましょうか', '遠慮します。……焦げた矢は、二度と使えないので'],
  'owen|raizu':   ['勝敗を記録しても構わないか', '勝ちだけ書いて。負けは、あたしが覚えてるから'],
  'owen|kain':    ['矢の本数を数えておく', '助かります。……僕も数えます。二人なら、間違えません'],
...
const CHAR_AFTER = {
  ...
  alvis: {
    ...
    e8: { act: '面頬を上げて、灰の降る空を見上げた。',
          line: '命令は、ひとつ残っていた。——「守れ」。……果たした。記録する' },
  },
  rita: {
    ...
    e6: { act: '王冠を持ち上げてみて、その重さに顔をしかめた。', line: '重っ……。こんなの被って三十年？　あたしなら三日で投げてる' },
    e7: { act: '白紙の束を空へ放り投げて、降ってくるのを見上げた。', line: 'よし、ぜんぶ取り返した！　……書くのは、誰かに頼むけどね' },
  ...
  erna: {
    ...
    e6: { act: 'はじめて積もった灰を指ですくい、しばらく見ていた。', line: 'やっと灰になった。……三十年ぶんの重さ。読むのに、少し時間がいるわ' },
  ...
  owen: {
    ...
    e7: { act: 'その場に膝をつき、まっさらな頁の一行目に何かを書いた。', line: '書き出しは決まっている。……「まだ、忘れきってはいない」だ' },
    e8: { act: '白紙になった頁に、はじめて自分で字を書いた。',
          line: '題名だけの帳面は、もう厚くしない。……ここからは、中身を書く' },
  },
  muse: {
    ...
    e6: { act: '倒れた王のまぶたに手を当てて、静かに閉じさせた。', line: 'やっと眠れるわね。……三十年ぶりの、いちばん深いやつ' },
  ...
  raizu: {
    ...
    e3: { act: '灰になった祈りの手を、卓を見るときの目で最後まで見ていた。', line: '降りたのね。……責めないわ。降り時を間違えないのは、才能よ' },
    e4: { act: '色の戻った街を見渡して、指の指輪をひとつ回した。', line: '派手じゃない。汚いし、うるさい。……こういう卓のほうが、儲かるの' },
...
const PAIR_AFTER = {
  ...
  'rita|owen':    ['今日のは、書かなくていいから', '書いた。……勇敢だった、と残しておく'],
  ...
  'shion|reia':   ['次の町、あっちだと思う', 'なら、あっちね。あたし、……信じる係だからね'],
  ...
  'reia|erna':    ['ちょっと、燃やしすぎじゃない？', '読んでから燃やしてるの。……弔いよ。順番も、ちゃんと選んでる'],
  ...
  'hazuki|kain':  ['踏み込む場所が、空いていました', '空けました。……刀は、僕より速いので'],
  'reia|raizu':   ['お金じゃ、逃げ足は買えないわよ？', 'あはは、あたしは降りないもの。……その足、いくらで張る？'],
  'reia|kain':    ['やっぱり、外さなかったね', '外さないだけです。……速いのは、やっぱりあなただ'],
  'erna|raizu':   ['あら、あなたも、色々と失くしてきたのね', '灰でも読んだの？……勝負は時には負けるものよ'],
  'erna|kain':    ['火は、要らなかったみたいね', '僕には必要ありません。……矢がダメになりますから'],
  'owen|raizu':   ['今日は勝ちの方に、書いておいた', '今後は、勝ちばかりよ。……負けの頁は、早く捨てなさい'],
  'owen|kain':    ['十七本、あったはずだが', '十六本です。……一本は、置いてきました'],
...
const BUBBLE_PAIR = {
  ...
  'baldo|hazuki': [['まだ抜くな', 'もう遅いです'], ['花は無事か', '髪にあります'], ['酒は飲むか？', '私強いですよ？']],
  ...
  'alvis|rita': [['下がっていろ', 'やなこった'], ['受け持つ', 'あたしが壊す'], ['無茶は許さん', '許可はいらない']],
  ...
  'alvis|erna': [['焼けるか', '焼けるわ'], ['灰は嫌いだ', 'あなたは平気'], ['記録が消える', '覚えておくわ']],
  ...
  'shion|hazuki': [['花、あった！', 'あとで摘みます'], ['前、開けた', '行きましょう'], ['早く！', '転びますよ']],
  ...
  'erna|owen': [['燃やす？', '止めてくれ'], ['私も書物は好き', '沢山あるぞ'], ['灰の頁ね', '題名だけある']],
  ...
  'owen|muse': [['手順を残そう', '良い事ね'], ['分量は', '手が覚えてる'], ['材料は何だ？', '動植物たち']],
...
const HALF_VOICE = {
  ...
  erna: {
    e7: ['読んでから、弔いに燃やす', '消した頁の灰も、読んであげる'],
    e8: ['読み切ってみせる。全部の灰を', '燃やせば、少しは軽くなるはず'],
  },
  owen: {
    e7: ['書き手が消えても、題名は残る', '私が最後の一冊だ。焼かせない'],
